...
Begin VB.Form Form1 
   ...
   Begin 智商提升器Install.GoodButton Button 
      Height          =   1572
      Left            =   3120
      TabIndex        =   1
      Top             =   3240
...
Select Case Tms
    ...
    Case 26000 To 26999
        ...
        Me.BackColor = 0
        Print "按ESC退出."
        Label = "本游戏版本为内测版本。" & Chr(10) & "其中许多背景音乐并没有被授予版权。" & Chr(10) & "您必须保证，" & Chr(10) & "在安装游戏之后不会将其扩散。" & Chr(10) & "所谓扩散，手段包括但不限于：" & Chr(10) & "上传互联网、复制给他人。" & Chr(10) & "然后才能单击“安装”键。"
    Case 28000 To 28999
        Label.Visible = True
        Tms = 29000
    Case 36000 To 36999
