...
Else
    With Player
        ...
        If .XX >= 550 Then
            Eni.Top = P.Top - 72
        Else
            Eni.Top = W(6).Top - Eni.Height - 666
        End If
        If .XX >= 686 And .XX <= 716 Then
            F = 2
        Else
            F = 6
        End If
...
End With
With Eni
    .Picture = LoadPicture(App.Path & "\eni.jpg")
    .Top = W(6).Top - .Height - 66
    .Left = 4666
End With
F = 6
End Sub
...
Private Sub Win()
If Val(GetSetting("iGlope", "woqu", "lv", 1)) < 13 Then
    SaveSetting "iGlope", "woqu", "lv", "13"
End If
