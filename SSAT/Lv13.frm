...
Qiang = k
'限制边框
If XX <= -66 Or XX + Player.Pang >= Width / Wow Then Qiang = 255
End Function
...
Else
    With Player
        ...
        If .XX <= F - 66 Then
            If Not ArSQ Then
                ArSQ = True
                Shell App.Path & "\" & App.EXEName & " 4", vbNormalFocus
            End If
        End If
    End With
End If
...
Public Sub Si(Optional TouTouDe As Boolean = False, Optional PMT As String = "你死了。")
If Not TouTouDe Then
    ...
    Drawer_Timer
Else
    Lv13Hider.Loader.Interval = 0
    MsgBox PMT, vbCritical + vbOKOnly, Caption
    Reset
End If
End Sub
...
Private Sub Win()
If Val(GetSetting("iGlope", "woqu", "lv", 1)) < 16 Then
    SaveSetting "iGlope", "woqu", "lv", "16"
End If
