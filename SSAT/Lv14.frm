...
Const G As Long = 3 'd
Const F As Long = 12 'd
Const JumpF As Long = 36 'd
...
With P
    ...
    .FillColor = &HFF0000
End With
W(5).BorderColor = RGB(240, 240, 240)
End Sub
...
Private Sub Win()
If Val(GetSetting("iGlope", "woqu", "lv", 1)) < 17 Then
    SaveSetting "iGlope", "woqu", "lv", "17"
End If
