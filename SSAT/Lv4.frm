...
Dim nM As Boolean
Dim dTms As Long, AL As Boolean, Ka As Boolean
...
dTms = dTms + 2
Wall(7).YY = Wall(7).YY - dTms
W(6).Top = W(6).Top + dTms * Wow
Main.Interval = 18
...
Private Sub Win()
If Val(GetSetting("iGlope", "woqu", "lv", 1)) < 6 Then
    SaveSetting "iGlope", "woqu", "lv", "6"
End If
