...
Private Sub Flyer_Timer()
FTms = FTms - 10
If FTms <= 0 Then
    Flyer.Interval = 0
    Exit Sub
End If
Wall(8).YY = Wall(8).YY + FTms
W(7).Top = W(7).Top - FTms * Wow
Label1.Top = W(7).Top
End Sub
...
Private Sub Win()
If Val(GetSetting("iGlope", "woqu", "lv", 1)) < 3 Then
    SaveSetting "iGlope", "woqu", "lv", "3"
End If
