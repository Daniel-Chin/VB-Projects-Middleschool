...
MsgBox "说明：单击红方块，放开左键，移动。 不要碰到黑色边框或者蓝色方块。坚持尽量多的时间！游戏开始之前请设置好屏幕像素（默认为12，如果游戏过程中红色方块不跟着鼠标走，尝试将其改成15），游戏过程中请勿移动程序窗口。千万不要最大化窗口！！！", vbOKOnly, "帮助"
End Sub
...
Private Sub Timer3_Timer()              '更新屏幕像素、钱
x_s = Int(Val(Text13))
Form1.更新数据
End Sub

Private Sub Timer5_Timer()        '修复后台运行的漏洞
Form1.Visible = True
Timer5.Interval = 0
End Sub
