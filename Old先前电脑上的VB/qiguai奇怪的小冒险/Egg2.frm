...
Select Case I.X
    Case 0 To 1500 - Pang '左管左侧
        ...
        End If
        '
    Case 1501 - Pang To 3150 - Pang '左管上？左
        I.X = I.X + (z - y) * WalkSpeed '左右移动
        If I.X <= 1501 - Pang Or (I.X >= 3150 - Pang And (I.y + Ai < Q.Top Or I.y - Gao > Q.Top + Q.Height)) Then '左侧下落或穿过？
            GoTo TiaoGuo
        End If
        If I.X >= 3150 - Pang And I.y + Ai >= Q.Top And I.y - Gao <= Q.Top + Q.Height Then
            '被？左墙卡主
            I.X = Q.Left - Pang
        End If
        '
        ...
        End If
        '
    Case 3151 - Pang To 3150 + Pang '左管上？下
        I.X = I.X + (z - y) * WalkSpeed '左右移动
        If I.X <= 3151 - Pang Or I.X > 3150 + Pang Then '左侧过？或右侧跳下
            GoTo TiaoGuo
        End If
        '
        vSpeed = vSpeed + Gravity
        ...
        Else
            '正往上飞
            If I.y - Gao <= Q.Top + Q.Height Then
                '顶到？
                vSpeed = 15 '弹性
        ...
        End If
        '
    Case 3151 + Pang To 7500 - Pang '中间地上
        I.X = I.X + (z - y) * WalkSpeed '左右移动
        '
        If I.X <= 3151 + Pang Then
            If I.y + Ai < 3000 Then
                '成功跳过
            Else
                I.X = 3152 + Pang
...
Private Sub XL_Timer()
xLs = xLs + 5
Q.Top = Q.Top + xLs
If Q.Top > Me.Height Then
    XL.Interval = 0
    xLs = 0
End If
End Sub
